    ...
    <>
      ...
      <main style={{ marginBottom: "100px" }}>
        ...
        <section className="about-us-container">
          ...
          <p>
            We are a premium brand dedicated to promoting a healthier
            lifestyle through high-quality titanium cookware. We believe that
            nutritious meals start with the right tools, and our innovative,
            non-toxic, and durable cookware empowers individuals and families to
            cook with confidence and ease. By combining health-conscious design
            with cutting-edge technology, Whealthy Vessel ensures that every
            meal is prepared in the safest and most efficient way possible.
          </p>
        </section>
